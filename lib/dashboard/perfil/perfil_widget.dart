      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              context.pushNamed(DashboardArranqueWidget.routeName);
            },
          ),
          title: Text(
            'Configuración',
                                          ...
                                          onPressed: () async {
                                            ...
                                            if (selectedMedia != null &&
                                              ...
                                              try {
                                                ...
                                                _model.isDataUploading_uploadDataThb =
                                                    false;
                                              }
                                              if (selectedUploadedFiles
                                                  ...
                                                  downloadUrls.length ==
                                                      selectedMedia.length) {
                                                safeSetState(() {
                                                  _model.uploadedLocalFile_uploadDataThb =
                                                      selectedUploadedFiles
                                                          .first;
                                                  _model.uploadedFileUrl_uploadDataThb =
                                                      downloadUrls.first;
                                                });
                                              } else {
                                                safeSetState(() {});
                                            ...
                                            await containerUserDataRecord!
                                                .reference
                                                .update(
                                                    createUserDataRecordData(
                                              photoUrl: _model
                                                  .uploadedFileUrl_uploadDataThb,
                                            ));
                                          },
                                          text: '',
                                          icon: Icon(
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Switch(
                                  ...
                                  activeTrackColor: Color(0x4D14B8A6),
                                ),
                              ],
                            ),
                            Divider(
