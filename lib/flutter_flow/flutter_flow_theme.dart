...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF217F8F);
  late Color secondary = const Color(0xFF0A5865);
  late Color tertiary = const Color(0xFF56C9DD);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xCB305FA0);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DE2D4BC);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF15AC9A);
  late Color warning = const Color(0xFFD9BB65);
  late Color error = const Color(0x88FE2B39);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF217F8F);
  late Color secondary = const Color(0xFF56C9DD);
  late Color tertiary = const Color(0xFF0A5865);
  ...
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x84E2D4BC);
